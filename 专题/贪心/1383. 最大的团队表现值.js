...
需要注意的是：
在 JS 中，没有现成的最小堆或优先队列的实现，需要自己实现一个最小堆。
在 JS 中，Number 的最大值是 Number.MAX_SAFE_INTEGER 9007199254740991，在某些 case 中会发生大于这个值得情况，使得最终的结果出现偏差。因此答案中需要增加 BigInt 的支持。
 */